...
- **板块基金**：板块 平均 35 分 🟦 偏冷（🔵 冰点 3、🟦 偏冷 26、🟢 正常 8、🟡 偏热 3）
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **板块** | 3 只 | 26 只 | 8 只 | 3 只 | 0 只 | 0 只 |
| **最热 Top6（名次 →）** | 1. 军工龙头ETF 71 | 2. 通信ETF 64 | 3. 5GETF 63 | 4. 银行ETF 56 | 5. 军工ETF 50 | 6. 中证红利ETF 44 |
| **最冷 Top6（名次 →）** | 1. 新能车ETF 15 | 2. 新能源车ETF 15 | 3. 稀有金属ETF基金 18 | 4. 化工ETF 22 | 5. 标普500ETF 22 | 6. 酒ETF 23 |

> **板块** 共 40 只，平均 35 分 🟦 偏冷。第一行是六档的只数分布；后两行按名次从左到右排，格子落在哪一列只表示名次，与该列的档位无关。
...
- 基金 515220 煤炭ETF: 净值不足 30 行
- 基金 512290 生物医药ETF: 净值不足 30 行
- 基金 512880 证券ETF: 净值不足 30 行
- 基金 159930 能源ETF: 净值不足 30 行
- 基金 510050 上证50ETF: 净值不足 30 行
- 基金 512400 有色金属ETF: 净值不足 30 行
- 基金 510500 中证500ETF: 净值不足 30 行
- 基金 159967 创成长ETF: 净值不足 30 行
- 基金 512100 中证1000ETF: 净值不足 30 行
- 基金 512670 国防ETF: 净值不足 30 行
<!-- DAILY_SUMMARY:END -->
