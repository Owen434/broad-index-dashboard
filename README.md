...
- **板块基金**：板块 平均 51 分 🟢 正常，过热 1 只 / 超冷 13 只
- **COMEX 黄金**：四周期斜率均值分位 25% 🟦 偏冷

<details>
<summary>展开完整表格（宽基 T+1 情景 / ETF 分板块 / 板块基金 / 黄金）</summary>
...
|---|---|---:|---:|---:|---|
| 上证指数 | A股宽基 | 5,631.06 | +0.29% | 77 | 🟡 偏热 |
| 科创50 | A股宽基 | 4,434.30 | +0.75% | 62 | 🟡 偏热 |
| 创业板指 | A股宽基 | 3,177.91 | -2.92% | 44 | 🟢 正常 |
| 恒生指数 | 港股宽基 | 8,337.41 | -0.89% | 44 | 🟢 正常 |
| 日经225 | 外盘宽基 | 9,167.48 | -0.24% | 37 | 🟦 偏冷 |
| 纳斯达克 | 美股宽基 | 7,794.95 | +0.18% | 35 | 🟦 偏冷 |
| 沪深300 | A股宽基 | 3,292.51 | -0.72% | 16 | 🔵 冰点 |

### ② 宽基 T+1 情景模拟（不同涨跌幅对应的风险）

| 指数 \ 明日涨跌 | +3% | +2% | +1% | +0% | -1% | -2% | -3% |
|---|---|---|---|---|---|---|---|
| 上证指数 | 🟠 高风险 80 | 🟡 偏热 80 | 🟡 偏热 79 | 🟡 偏热 76 | 🟢 正常 50 | 🟢 正常 44 | 🟢 正常 44 |
| 科创50 | 🟡 偏热 77 | 🟡 偏热 75 | 🟢 正常 56 | 🟢 正常 56 | 🟢 正常 56 | 🟦 偏冷 37 | 🟦 偏冷 31 |
| 创业板指 | 🟢 正常 56 | 🟢 正常 44 | 🟢 正常 44 | 🟦 偏冷 37 | 🟦 偏冷 24 | 🟦 偏冷 22 | 🔵 冰点 16 |
| 恒生指数 | 🟢 正常 56 | 🟢 正常 56 | 🟢 正常 56 | 🟢 正常 44 | 🟦 偏冷 32 | 🟦 偏冷 23 | 🟦 偏冷 23 |
| 日经225 | 🟡 偏热 69 | 🟢 正常 56 | 🟢 正常 44 | 🟦 偏冷 36 | 🟦 偏冷 30 | 🟦 偏冷 23 | 🟦 偏冷 20 |
| 纳斯达克 | 🟢 正常 58 | 🟢 正常 50 | 🟢 正常 49 | 🟦 偏冷 34 | 🟦 偏冷 34 | 🟦 偏冷 28 | 🟦 偏冷 21 |
| 沪深300 | 🟢 正常 58 | 🟢 正常 58 | 🟢 正常 43 | 🟦 偏冷 23 | 🔵 冰点 16 | 🔵 冰点 14 | 🔵 冰点 14 |

### ③ ETF 分板块资金流风险（仅合并板块，截至 2025-02-21）

| 板块 | 方向 | 当日净申赎(亿元) | 近5日(亿元) | 绝对值分位 | 风险等级 |
|---|---|---:|---:|---:|---|
| 医药医疗 | 净赎回 | -5.06 | -7.99 | 90% | 🟠 高风险 |
| 中证500 | 净赎回 | -3.18 | -4.57 | 76% | 🟡 偏热 |
| 科创50 | 净赎回 | -3.20 | -10.27 | 68% | 🟡 偏热 |
| 军工 | 净赎回 | -2.46 | -10.55 | 65% | 🟡 偏热 |
| 中概互联 | 净申购 | +2.32 | +1.60 | 65% | 🟡 偏热 |
| 食品饮料 | 净赎回 | -2.31 | -7.13 | 54% | 🟢 正常 |
| 金融地产 | 净申购 | +1.78 | +6.05 | 41% | 🟢 正常 |
| 芯片半导体 | 净申购 | +1.14 | +7.44 | 23% | 🟦 偏冷 |
| 创业板 | 净赎回 | -0.59 | -2.03 | 14% | 🔵 冰点 |
| 沪深300 | 净申购 | +0.16 | -0.23 | 10% | 🔵 冰点 |
| 上证50 | -- | -- | -- | -- | ⚪ 无数据 |
| 中证1000 | -- | -- | -- | -- | ⚪ 无数据 |
...
|---|---:|---:|---:|---:|---|---|
| 板块 | 50 | 50 | 51 | 1 / 13 | 标普500ETF(84) | 🟢 正常 |

### ⑤ COMEX 黄金 · 多周期均线斜率风险

最新价：2,606.1 美元 · 2024-09-06
...
---
生成时间 2026-09-07 14:33　数据源 AKShare。
本页为技术观察，不构成任何投资建议。

</details>

> 由 GitHub Actions 每个交易日自动重写，完整版：[`docs/daily_summary.md`](docs/daily_summary.md) · 机器可读：[`docs/daily_summary.json`](docs/daily_summary.json)
<!-- DAILY_SUMMARY:END -->
