...
- **宽基指数**：16 个，最热 深证成指 🟢 正常（56 分）；高风险及以上 0 个
- **ETF 资金流**：净申赎分位最高 金融地产（09-15）（净申购 +0.23 亿，分位 95%）🔵 冰点；最低 科创50（09-15）（净赎回 -6.77 亿，分位 13%）🟠 高风险
- **板块基金**：自选 平均 50 分 🟢 正常（🔵 冰点 2、🟦 偏冷 7、🟢 正常 9、🟡 偏热 7、🟠 高风险 1）
- **COMEX 黄金**：四周期斜率均值分位 36% 🟦 偏冷
...
| 韩国综合指数 | 外盘宽基 | 6,717.97 | +1.37% | 38 | 🟦 偏冷 |
...
| 韩国综合指数 | 🟢 正常 56 | 🟢 正常 56 | 🟢 正常 56 | 🟦 偏冷 37 | 🟦 偏冷 37 | 🟦 偏冷 37 | 🟦 偏冷 24 |
...
|---|---|---:|---:|---:|---|
| 金融地产（09-15） | 净申购 | +0.23 | +0.08 | 95% | 🔵 冰点 |
| MSCI中国A50（09-15） | 净申购 | +0.16 | -0.17 | 90% | 🔵 冰点 |
| 创业板（09-15） | 净申购 | +20.72 | +37.92 | 89% | 🔵 冰点 |
| 深证100（09-15） | 净申购 | +0.53 | +2.01 | 89% | 🔵 冰点 |
| 中证500（09-15） | 净申购 | +19.35 | +7.46 | 87% | 🔵 冰点 |
| 上证50（09-15） | 净申购 | +4.23 | +10.14 | 79% | 🟦 偏冷 |
| 沪深300（09-15） | 净申购 | +6.08 | +17.60 | 76% | 🟦 偏冷 |
| 上证180（09-15） | 净申购 | +0.04 | +0.08 | 76% | 🟦 偏冷 |
| 中证800（09-15） | 净申购 | +0.11 | +0.39 | 76% | 🟦 偏冷 |
| 光伏（09-15） | 净赎回 | -0.03 | -0.22 | 76% | 🟦 偏冷 |
| 金融科技（09-15） | 净申购 | +0.36 | +1.54 | 74% | 🟦 偏冷 |
| 食品饮料（09-15） | 净申购 | +0.31 | +1.55 | 71% | 🟦 偏冷 |
| 中概互联（09-15） | 净申购 | +0.11 | +1.97 | 69% | 🟦 偏冷 |
| 畜牧养殖（09-15） | 净申购 | +0.39 | +1.40 | 67% | 🟦 偏冷 |
| 军工（09-15） | 净申购 | +0.01 | +0.98 | 61% | 🟦 偏冷 |
| 中证1000（09-15） | 净赎回 | -0.38 | -20.33 | 56% | 🟢 正常 |
| 医药医疗（09-15） | 净赎回 | -0.23 | -0.12 | 55% | 🟢 正常 |
| 中证A500（09-15） | 净赎回 | +0.00 | +0.12 | 46% | 🟢 正常 |
| 钢铁（09-15） | 净赎回 | -0.07 | -0.06 | 46% | 🟢 正常 |
| 汽车（09-15） | 净赎回 | -0.01 | +0.04 | 44% | 🟢 正常 |
| 芯片半导体（09-15） | 净赎回 | -1.83 | -0.28 | 26% | 🟡 偏热 |
| 有色金属（09-15） | 净赎回 | -2.05 | -1.56 | 20% | 🟡 偏热 |
| 科创50（09-15） | 净赎回 | -6.77 | +10.27 | 13% | 🟠 高风险 |

### ④ 板块基金风险汇总（截至 2026-09-16）

| 类型 / 排行 | 🔵 冰点 | 🟦 偏冷 | 🟢 正常 | 🟡 偏热 | 🟠 高风险 | 🔴 极端风险 |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **自选** | 2 只 | 7 只 | 9 只 | 7 只 | 1 只 | 0 只 |
| **板块** | 1 只 | 29 只 | 20 只 | 0 只 | 0 只 | 0 只 |
| **最热 Top6（名次 →）** | 1. 财通科技创新混合C 84 | 2. 财通集成电路产业股票C 77 | 3. 国联安优选行业混合A 76 | 4. 鹏华创新未来混合(LOF)C 75 | 5. 华泰柏瑞质量成长C 74 | 6. 广发远见智选混合C 69 |
| **最冷 Top6（名次 →）** | 1. 建信新兴市场混合(QDII)C 15 | 2. 泰信发展主题混合 17 | 3. 旅游ETF 19 | 4. 基建ETF 20 | 5. 中证红利ETF 21 | 6. 消费ETF 22 |

> **自选** 共 26 只，平均 50 分 🟢 正常；**板块** 共 50 只，平均 39 分 🟦 偏冷。第一行是六档的只数分布；后两行按名次从左到右排，格子落在哪一列只表示名次，与该列的档位无关。

### ⑤ COMEX 黄金 · 多周期均线斜率风险

最新价：4,371.4 美元 · 2026-09-16

| 周期 | 均线斜率 | 方向 | 斜率分位 | 风险等级 |
|---|---:|---|---:|---|
| 5 日 | -15.100 | 下行 | 29% | 🟦 偏冷 |
| 20 日 | -10.465 | 下行 | 18% | 🔵 冰点 |
| 30 日 | +2.123 | 上行 | 43% | 🟢 正常 |
| 60 日 | +5.918 | 上行 | 55% | 🟢 正常 |
| 综合 | -- | 四周期均值 | 36% | 🟦 偏冷 |
