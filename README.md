...
- **ETF 资金流**：净申赎分位最高 深证100（净申购 +0.48 亿，分位 87%）🔵 冰点；最低 MSCI中国A50（净赎回 -0.19 亿，分位 24%）🟡 偏热
- **板块基金**：自选 平均 43 分 🟢 正常（🔵 冰点 2、🟦 偏冷 7、🟢 正常 12、🟡 偏热 5）
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **自选** | 2 只 | 7 只 | 12 只 | 5 只 | 0 只 | 0 只 |
| **板块** | 0 只 | 34 只 | 15 只 | 1 只 | 0 只 | 0 只 |
| **最热 Top6（名次 →）** | 1. 财通集成电路产业股票C 64 | 2. 国联安优选行业混合A 64 | 3. 银行ETF 62 | 4. 广发远见智选混合C 62 | 5. 信澳产业优选一年持有混合C 62 | 6. 泰康香港银行指数C 62 |
| **最冷 Top6（名次 →）** | 1. 泰信发展主题混合 16 | 2. 东方阿尔法科技智选混合发起C 18 | 3. 有色金属ETF 22 | 4. 化工ETF 22 | 5. 证券ETF 22 | 6. 券商ETF 22 |

> **自选** 共 26 只，平均 43 分 🟢 正常；**板块** 共 50 只，平均 35 分 🟦 偏冷。第一行是六档的只数分布；后两行按名次从左到右排，格子落在哪一列只表示名次，与该列的档位无关。

### ⑤ COMEX 黄金 · 多周期均线斜率风险

最新价：4,306.2 美元 · 2026-09-15
