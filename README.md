...
- **宽基指数**：16 个，最热 纳斯达克 🟡 偏热（62 分）；高风险及以上 0 个
- **ETF 资金流**：净申赎分位最高 有色金属（净申购 +5.95 亿，分位 97%）🔵 冰点；最低 畜牧养殖（净赎回 -2.16 亿，分位 1%）🔴 极端风险
- **板块基金**：板块 平均 47 分 🟢 正常（🟦 偏冷 21、🟢 正常 22、🟡 偏热 7）
...
| 类型 / 排行 | 只数 | 平均评分 | 🔵 冰点 | 🟦 偏冷 | 🟢 正常 | 🟡 偏热 | 🟠 高风险 | 🔴 极端风险 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| **板块** | 50 | 47 | 0 只 | 21 只 | 22 只 | 7 只 | 0 只 | 0 只 |
...
> 第一行是六档的只数分布；后两行按名次从左到右排，格子落在哪一列只表示名次，与该列的档位无关。

### ⑤ COMEX 黄金 · 多周期均线斜率风险

最新价：4,461.7 美元 · 2026-09-07

| 周期 | 均线斜率 | 方向 | 斜率分位 | 风险等级 |
|---|---:|---|---:|---|
| 5 日 | -7.120 | 下行 | 33% | 🟦 偏冷 |
| 20 日 | +0.660 | 上行 | 41% | 🟢 正常 |
| 30 日 | +10.790 | 上行 | 66% | 🟡 偏热 |
| 60 日 | +2.185 | 上行 | 39% | 🟦 偏冷 |
| 综合 | -- | 四周期均值 | 45% | 🟢 正常 |
<!-- DAILY_SUMMARY:END -->
